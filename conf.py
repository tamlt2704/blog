...
BLOG_TITLE = "Tam's blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://tamlt2704.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://tamlt2704.github.io/blog/"
BLOG_EMAIL = "tamlt2704@gmail.com"
BLOG_DESCRIPTION = "my learning corner"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        ...
        "rsync -rPv --delete-after --execute old_blog --exclude .git --exclude .gitignore --exclude cache/ --exclude .doit.db.db output/ .",
        "git add -A",
